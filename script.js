...
function applySkin() {
    if (gameData.skin === "yellow") {
        ...
        duck.style.boxShadow = "0 0 20px rgba(255, 255, 0, 0.4)";
    } else if (gameData.skin === "blue") {
        duck.style.background = "#4da6ff";
        duck.style.boxShadow = "0 0 20px rgba(77, 166, 255, 0.6)";
    } else if (gameData.skin === "red") {
        duck.style.background = "#ff4d4d";
        duck.style.boxShadow = "0 0 20px rgba(255, 77, 77, 0.6)";
    }
}
...
autoClick.onclick = () => {
    if (!gameData.autoClicker && gameData.coins >= 200) {
        gameData.coins -= 200;
